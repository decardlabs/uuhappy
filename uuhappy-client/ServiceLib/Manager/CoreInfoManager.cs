...
public sealed class CoreInfoManager
{
    ...
    {
        var urlN = GetCoreUrl(ECoreType.uuhappy);
        ...
        [
            new CoreInfo
                {
                    CoreType = ECoreType.uuhappy,
                    Url = GetCoreUrl(ECoreType.uuhappy),
                    ReleaseApiUrl = urlN.Replace(Global.GithubUrl, Global.GithubApiUrl),
                    DownloadUrlWin64 = urlN + "/download/{0}/uuhappy-windows-64.zip",
                    DownloadUrlWinArm64 = urlN + "/download/{0}/uuhappy-windows-arm64.zip",
                    DownloadUrlLinux64 = urlN + "/download/{0}/uuhappy-linux-64.zip",
                    DownloadUrlLinuxArm64 = urlN + "/download/{0}/uuhappy-linux-arm64.zip",
                    DownloadUrlOSX64 = urlN + "/download/{0}/uuhappy-macos-64.zip",
                    DownloadUrlOSXArm64 = urlN + "/download/{0}/uuhappy-macos-arm64.zip",
                },
