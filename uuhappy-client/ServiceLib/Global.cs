...
public class Global
{
    ...
    public const string AppName = "uuhappy";
    ...
    public const string AutoRunName = "uuhappyAutoRun";
    ...
    public const string AvaAssets = "avares://uuhappy/Assets/";
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
    {
        ...
        { ECoreType.uuhappy, "decardlabs/uuhappy" },
    };
