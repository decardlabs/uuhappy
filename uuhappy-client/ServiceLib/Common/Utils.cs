...
public class Utils
{
    ...
    public static string StartupPath()
    {
        ...
        {
            return Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "uuhappy");
        }
    ...
    public static bool IsPackagedInstall()
    {
        try
        {
            ...
            if (p.StartsWith("/opt/uuhappy", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/lib/uuhappy", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }

            if (p.StartsWith("/usr/share/uuhappy", StringComparison.OrdinalIgnoreCase))
            {
                return true;
            }
        }
