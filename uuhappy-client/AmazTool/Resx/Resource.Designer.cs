...
namespace AmazTool.Resx {
    ...
    internal class Resource {
        ...
        /// <summary>
        ///   查找类似 Failed to terminate the uuhappy. Close it manually, or the upgrade may fail. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Start uuhappy, please wait... 的本地化字符串。
        /// </summary>
        internal static string Restartuuhappy {
            get {
                return ResourceManager.GetString("Restartuuhappy", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   查找类似 Try to terminate the uuhappy process... 的本地化字符串。
        /// </summary>
